...
func negotiate(scheme, address string) (negotiationResponse, error) {
	...
	var negotiationUrl = url.URL{Scheme: scheme, Opaque: "//" + address + "/signalr/negotiate", Host: address, Path: "/signalr/negotiate"}
...
func connectWebsocket(address string, params negotiationResponse, hubs []string) (*websocket.Conn, error) {
	...
	var connectionUrl = url.URL{Scheme: "wss", Opaque: "//" + address + "/signalr/connect", Host: address, Path: "signalr/connect"}
